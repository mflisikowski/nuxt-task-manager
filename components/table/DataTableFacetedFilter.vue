...
import type { TasksDataTableFacetedFilter } from "@/types/tasks";

// prettier-ignore
import { CommandItem, CommandList, Command, CommandSeparator, CommandEmpty, CommandGroup, CommandInput } from "@/components/ui/command";
// prettier-ignore
...
const props = defineProps<TasksDataTableFacetedFilter>();
